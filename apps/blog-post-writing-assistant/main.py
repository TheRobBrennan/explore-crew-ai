# Crude implementation of a blog post writing assistant using CrewAI - https://levelup.gitconnected.com/how-to-implement-a-simple-ui-for-crewai-applications-91f29c04fc8f
...
print("Welcome to the blog post writing assistant!")
