...
from agents.market_research_analyst.market_research_analyst import create_market_research_analyst, ROLE, GOAL, BACKSTORY
from tools.normalize_whitespace.normalize_whitespace import normalize_whitespace

def test_create_market_research_analyst():
    with patch('agents.market_research_analyst.market_research_analyst.Agent') as MockAgent:
